...
// MockNaverCloudClient 테스트용 모킹 클라이언트
type MockNaverCloudClient struct {
...
func NewMockNaverCloudClient() *MockNaverCloudClient {
	return &MockNaverCloudClient{
		LoadBalancers: []vloadbalancer.LoadBalancerInstance{},
		TargetGroups:  []vloadbalancer.TargetGroup{},
		Servers:       []vserver.ServerInstance{},
	}
...
func (m *MockNaverCloudClient) CreateLoadBalancerInstance(req *vloadbalancer.CreateLoadBalancerInstanceRequest) (*vloadbalancer.CreateLoadBalancerInstanceResponse, error) {
	m.CreateLBCalled++
...
func (m *MockNaverCloudClient) GetLoadBalancerInstanceList(req *vloadbalancer.GetLoadBalancerInstanceListRequest) (*vloadbalancer.GetLoadBalancerInstanceListResponse, error) {
...
func (m *MockNaverCloudClient) DeleteLoadBalancerInstances(req *vloadbalancer.DeleteLoadBalancerInstancesRequest) (*vloadbalancer.DeleteLoadBalancerInstancesResponse, error) {
	m.DeleteLBCalled++
...
func (m *MockNaverCloudClient) CreateTargetGroup(req *vloadbalancer.CreateTargetGroupRequest) (*vloadbalancer.CreateTargetGroupResponse, error) {
	m.CreateTGCalled++
...
func (m *MockNaverCloudClient) DeleteTargetGroups(req *vloadbalancer.DeleteTargetGroupsRequest) (*vloadbalancer.DeleteTargetGroupsResponse, error) {
	m.DeleteTGCalled++
...
func (m *MockNaverCloudClient) GetTargetGroupList(req *vloadbalancer.GetTargetGroupListRequest) (*vloadbalancer.GetTargetGroupListResponse, error) {
...
func (m *MockNaverCloudClient) CreateLoadBalancerListener(req *vloadbalancer.CreateLoadBalancerListenerRequest) (*vloadbalancer.CreateLoadBalancerListenerResponse, error) {
...
func (m *MockNaverCloudClient) AddTarget(req *vloadbalancer.AddTargetRequest) (*vloadbalancer.AddTargetResponse, error) {
	m.AddTargetCalled++
...
func (m *MockNaverCloudClient) GetServerInstanceList(req *vserver.GetServerInstanceListRequest) (*vserver.GetServerInstanceListResponse, error) {
	m.GetServersCalled++
...
// 테스트 헬퍼 메서드들
func (m *MockNaverCloudClient) AddMockLoadBalancer(lbID, lbName, status string) {
	lb := vloadbalancer.LoadBalancerInstance{
...
func (m *MockNaverCloudClient) AddMockTargetGroup(tgID, tgName string, port int32) {
	tg := vloadbalancer.TargetGroup{
...
func (m *MockNaverCloudClient) AddMockServer(serverID, serverName, privateIP string) {
...
func (m *MockNaverCloudClient) Reset() {
